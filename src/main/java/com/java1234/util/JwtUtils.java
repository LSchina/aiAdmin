...
public class JwtUtils {
   ...
   /* public static void main(String[] args) throws InterruptedException {
    ...
    public static void main(String[] args) {
        String str = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIxIiwic3ViIjoi5bCP5piOIiwiaXNzIjoiSmF2YTEyMzQiLCJpYXQiOjE3MTMyODI1MjYsImV4cCI6MTcxMzI4NjEyNn0.d3pPah1WXDhnDLEr9YEodRP_XuKMDKN6W2kdRCmHaBE";
